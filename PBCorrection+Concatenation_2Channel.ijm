...
do {
	...
	saveAs("Tiff",dir_green+list[i]+"_PBCorrected_Green");
	...
	//run("8-bit");
	//Save PB corrected stacks.
	saveAs("Tiff",dir_red+list[i]+"_PBCorrected_Red");
...
//Open all the PB Corrected images in green directory.
list = getFileList(dir_green);

open(dir_green, list[0]);


//Save all of the PB Corrected images.
saveAs("Tiff",dir_green+"Concatenated");
run("Close All");

//Open all the green PB Corrected images in red directory.
list = getFileList(dir_red);

open(dir_red, list[0]);

//Save all of the red PB Corrected images.
saveAs("Tiff",dir_red+"Concatenated");
run("Close All");
